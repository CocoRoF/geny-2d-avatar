...
`normal` 프리셋 표준은 **머리 8 + 옷 4 = 12** 개 on. **v1.3.0 에서 12/12 달성**: 4 hair sway + 5 fuwa + ahoge/accessory_sway/body_breath_phys 3 secondary.
...
- `rig-templates/base/halfbody/v1.2.0/physics/physics.json` — v1.2.0 (9 설정 / 9 출력).
- `rig-templates/base/halfbody/v1.3.0/physics/physics.json` — **v1.3.0 (12 설정 / 13 출력, 본 매핑표 행 3 달성)**.
- `docs/03 §6.2` — 물리 파일 규약.

---

## 6. v1.3.0 추가분 상세 (세션 31)
