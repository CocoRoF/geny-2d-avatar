...
export interface PngInfo {
  ...
  /** 색 유형 명칭 — 0: grayscale, 2: rgb, 3: palette, 4: grayscale+alpha, 6: rgba. */
  readonly colorTypeName: "grayscale" | "rgb" | "palette" | "grayscale_alpha" | "rgba" | "unknown";
  readonly hasAlpha: boolean;
}

const COLOR_TYPE_NAME: Record<number, PngInfo["colorTypeName"]> = {
  0: "grayscale",
  2: "rgb",
  3: "palette",
  4: "grayscale_alpha",
...
export function readPngInfo(buf: Buffer): PngInfo | null {
  if (buf.length < 8 + 8 + 13 + 4) return null;
